...
class Venta {
        ...
        $sql = "SELECT
            ...
            if($resultado){
                while($fila = $resultado->fetch_assoc()){
                    ...
                    $entidadAux->fk_idcliente = $fila["nombre_cliente"];
                    $entidadAux->fk_idproducto = $fila["nombre_producto"];
    ...
    public function obtenerFacturacionMensual($mes){
        ...
        $fila = $resultado->fetch_assoc(); //ya que es un select, hay q devolver un arrat asociativo
    ...
    public function obtenerFacturacionAnual($anio){
        ...
        $fila = $resultado->fetch_assoc(); //ya que es un select, hay q devolver un array asociativo
